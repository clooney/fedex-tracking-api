FedEx Tracking API - Java
================================
Use Java to track FedEx shipments with FedEx Tracking API.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.fedex;
    ...
    public class CreateFedExTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("775429982388");
                createTrackingParams.setCourierCode("fedex");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreateFedExTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("775432760763");
                createTrackingParams1.setCourierCode("fedex");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("775432791800");
                createTrackingParams2.setCourierCode("fedex");
...
Get status of the shipment:
    ...
    public class GetFedExTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("775432791800");
                trackingParams.setCourierCode("fedex");
...
Update a tracking by ID:
    ...
    public class UpdateFedExTrackingExample {
